package com.example.nareshkrish.androidthingslora;
...
public class MainActivity extends Activity implements UARTResponseListener {
    ...
    private WisnodeLora mWisnodeLora;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.i(TAG, "Hello world from android things");
    }
    ...
    protected void onResume() {
        ...
        mWisnodeLora = new WisnodeLora("USB1-1.4:1.0", 115200);
